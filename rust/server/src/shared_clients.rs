...
use message_layer::application_layer::MessageBRef;
...
impl SharedClients {
	...
	pub fn send_to_client(&'static self, dest_username: &str, message: &MessageBRef) -> bool {
	...
	pub fn send_to_all(&'static self, source_username: &str, message: &MessageBRef) -> bool {
		let unlocked_clients = self.clients.read().unwrap();
